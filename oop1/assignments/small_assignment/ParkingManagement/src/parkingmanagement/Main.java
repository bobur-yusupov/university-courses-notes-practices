...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        ParkingSpot spot1 = new ParkingSpot(ParkingSpotSize.SMALL, 10);
        ParkingSpot spot2 = new ParkingSpot(ParkingSpotSize.MEDIUM, 15);
        ...
        parkingLot.filterParkingSpot(ParkingSpotSize.SMALL, 10).forEach(spot -> System.out.println(spot.getSize()));
        ...
        parkingLot.removeCar(parkingLot.getReservations().get(0));
